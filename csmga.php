...
<div style="margin-left: auto; margin-right: auto; padding-top: 30px; padding-bottom: 50px; width: 80%;">
<div class="hover01 ">
    ...
    ?>
    <div style="object-fit: contain; margin: auto; display: inline-block; padding-left: 2.5%; padding-top: 2.5%;">
    <form method="get" type="submit" action="showpckg.php" name="pckg" >
        <figure><img src="<?php echo $pic; ?>" /></figure>
        <span>
            <h3><?php echo $name; ?></h3>
            <p><?php echo $desc; ?></p>
            <button class="message_button" method="get" type="submit"  name="pckg" value="<?php print $id;?>">Részletek megtekintése</button>
        </span>
    </div>
    </form>
    <?php }
